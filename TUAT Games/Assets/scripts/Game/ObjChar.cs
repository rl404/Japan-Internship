...
public class ObjChar : MonoBehaviour
{
	...
	public void changeReady(bool r) {
		m_Ready = r;
	}
	...
	public void changeNearEnemy(bool n) {
		nearEnemy = n;
	}
	...
	public void End(int end) {
		...
		if (end == 1) {
			m_Animator.Play ("WIN00");
			transform.position = originalPosition;
		} else {
			m_Animator.Play ("LOSE00");
			transform.position = originalPosition;
		}
